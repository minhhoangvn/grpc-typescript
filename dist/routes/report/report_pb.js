...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.Message.toObject = function (includeInstance, msg) {
        var f, obj = {
            reportinfoList: jspb.Message.toObjectList(msg.getReportinfoList(), proto.ReportInformation.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.Message.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.ReportInformation.serializeBinaryToWriter);
    }
};
/**
...
proto.Message.prototype.getReportinfoList = function () {
    return /** @type{!Array<!proto.ReportInformation>} */ (jspb.Message.getRepeatedWrapperField(this, proto.ReportInformation, 1));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.ReportInformation.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            statusList: jspb.Message.toObjectList(msg.getStatusList(), proto.ReportStatus.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.ReportInformation.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.ReportStatus.serializeBinaryToWriter);
    }
};
/**
 * optional int32 id = 1;
...
proto.ReportInformation.prototype.getStatusList = function () {
    return /** @type{!Array<!proto.ReportStatus>} */ (jspb.Message.getRepeatedWrapperField(this, proto.ReportStatus, 3));
};
...
proto.Status.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getReportinfoList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, proto.ReportInformation.serializeBinaryToWriter);
    }
};
/**
...
proto.Status.prototype.getReportinfoList = function () {
    return /** @type{!Array<!proto.ReportInformation>} */ (jspb.Message.getRepeatedWrapperField(this, proto.ReportInformation, 4));
};
/** @param {!Array<!proto.ReportInformation>} value */
